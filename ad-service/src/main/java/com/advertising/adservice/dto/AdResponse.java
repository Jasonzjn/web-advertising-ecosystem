...
public class AdResponse {
    ...
    public AdResponse(Long id, String title, String content, String imageUrl, String targetUrl,
                      String targetWebsite, LocalDateTime startDate, LocalDateTime endDate,
